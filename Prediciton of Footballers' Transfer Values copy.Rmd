...
This graph seems to highlight a correlation between the time left on a player's contract and his transfer fee. The longer time there is left of the contract at the time of the transfer, the more expensive the player will be. When the period is below 20 months, then the transfer fee does not exceed 30 million pounds. When above 20 months, we see that the transfer fees can reach 30 million pounds - some transfer fees even reach 40 million pounds, especially when the contract is above 40 months. 
