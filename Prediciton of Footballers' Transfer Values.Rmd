...
p.time <- ggplot(data=df.viz, aes(x = contract.left.month , y = transfer.fee)) +
  ...
  labs(y="Transfer price\nin M£",x="Time left on contract in months")+
...
```{r two_plots_same_size_side_by_side_2, fig.width=3.5, fig.height=4}
...
In the appendix we also have a bar chart of the average spending on transfers per club in the different leagues. The printed visualizations in the papers are supporting that we include this variables in the upcomming prediction models. Graphs for most of the reamning predicting variables are avaiable in the R code.   
