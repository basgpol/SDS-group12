...
We have to gather data in order to do our analysis. We gathered the relevant data from the websites Transfermarkt.co.uk, Google.com and Wikipedia.org. Transfermarkt.co.uk contains information on football transfers, player information and  performance statistics. We expect all this information to be highly relevant in order to predict the transfer value of a player. We used Wikipedia.org in order to find data about the final table ranking for the five leagues in the season before the transfers (season 14/15).
...
The scraper for Wikipedia ran through the different webpages with the table ranking for the season 14/15 in the five leagues. The table rankings were hereafter merged into one data frame containing club data.
