...
\begin{table}[]
\centering
\caption{Personal Player Variables}
\label{my-label}
\begin{tabular}{l|l}
\hline
...
transferage  & Age of player when transfer occurred  \\ \hline
\end{tabular}
\end{table}
...
contract.left.month  & Months left of the transfered players' contract at transfer \\ \hline
\end{tabular}
\end{table}
...
transfer.fee  & The transfer fee measured in million £    \\ \hline
\end{tabular}
\end{table}
