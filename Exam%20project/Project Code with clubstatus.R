...
profile.links # showing the first 300 links
...
season.stat.links # showing the first 200 links to transfered players performance stats for 14/15
...
v
t
e`, "Bayern Munich (C)"="Bayern Munich", "SC Freiburg (R)"="SC Freiburg", "SC Paderborn 07 (R)"="SC Paderborn",
...
# All club names should match now, so it is possible to merge club.data and 

# Merging the dataframes by clubnames
