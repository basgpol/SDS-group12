...
```{r two_plots_same_size_side_by_side_2, fig.width=3.5, fig.height=3.5, fig.cap="Scatter plots"}
...
```{r two_plots_same_size_side_by_side, fig.width=3.5, fig.height=4, fig.cap="Bar Charts"}
